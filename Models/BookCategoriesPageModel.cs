...
namespace Cosa_Cristina_lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cosa_Cristina_lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cosa_Cristina_lab8Context context,
